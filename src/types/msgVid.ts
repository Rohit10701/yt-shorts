...
export class MsgVideo extends VideoGen {
    ...
    async generateVideo() {
        ...
        console.log("Creating voices for each message in the script...");
        const voiceFiles = [];
        ...
        if (this.useBgMusic) {
            ...
            console.log("Overlaying background audio on top of the voice audio file...");
            ...
            this.log("Background audio is " + bgAudio)
                console.log("Background audio is " + bgAudio)
            ...
            console.log("Background audio overlay disabled! Using voice audio file only...");
        }

        // Get durations of each audio file
        this.log('Making list of durations for each audio file...');
        console.log("Making list of durations for each audio file...");
        ...
        console.log("Creating video from audio file with on-screen text...");
        ...
        console.log("Full duration of audio is " + fullDuration)
        ...
        if (this.useBgVideo) {
            ...
            console.log(`Background video file: ${bgVideo}`);
            ...
            console.log("Background video overlay disabled! Using black background...");
        }
        ...
        for (const [index, img] of messageImages.entries()) {
            ...
            console.log(`Image #${index} path is ${img}`)
            console.log(`Image #${index} y is ${((400 * 1.4) + (70 * index))}`)
            
            console.log(`Image #${index} start duration is ${imgStartDuration} s`)
            console.log(`Image #${index} full duration is ${(fullDuration - imgStartDuration)} s`)
        }
        ...
        creator.on('progress', e => {
            ...
            console.log(`FFCreator progress: rendering ${(e.percent * 100) >> 0}%`);
        });
    ...
    async generateMessagHeader(name: string): Promise<string> {
        ...
        console.log("Message header image created successfully!");
        return headerFile;
    }
